...
public class HomePhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.photo_home_fragment, container, false);
        mDBLoginPhoto = new DBLoginPhoto(getContext());
        User_Email = mDBLoginPhoto.get_Email();
        mListViewAllOrder = view.findViewById(R.id.ListALLOrder);
    ...
    public void listData() {
        HomePhotoFragment.ListAdapter ad = new HomePhotoFragment.ListAdapter(List_AllOrder);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent openCompany = new Intent(getActivity(), ShowAllOrderDetActivity.class);
    ...
    public void Show_Photo(){
        String NEWS_URL = "http://192.168.43.57/photo/showAllorder.php?photo_email="+User_Email;
